...
- Keys are validated against the Asyar design token allowlist (see [Section 14 — Design System](#14-design-system--ui-consistency)). Unknown variable names are silently ignored — they will not apply.
